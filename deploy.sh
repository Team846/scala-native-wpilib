...
# install ssh keys
openssl aes-256-cbc -K $encrypted_54ca9f9d5537_key -iv $encrypted_54ca9f9d5537_iv -in .repodeploykey.enc -out .repodeploykey -d
...
git add .
git commit -m "(scala-native-wpilib): automated deploy to GitHub Pages"
