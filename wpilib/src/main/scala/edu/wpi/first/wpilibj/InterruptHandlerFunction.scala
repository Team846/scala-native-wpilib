...
/**
  ...
  *
  * @tparam T The type of the parameter that should be returned to the the method { @link
  * #interruptFired(int, Object)}
  */
abstract class InterruptHandlerFunction[T <: Object] {
  /**
    ...
    */
  private[wpilibj] class Function extends InterruptJNIHandlerFunction {
    @SuppressWarnings(Array("unchecked")) override def apply(interruptAssertedMask: Int, param: Any): Unit = {
      interruptFired(interruptAssertedMask, param.asInstanceOf[T])
    }
  }

  final private[wpilibj] val m_function = new Function
  ...
  /**
    ...
    */
  def interruptFired(interruptAssertedMask: Int, param: T): Unit
  ...
  /**
    ...
    */
  def overridableParameter: T = null.asInstanceOf[T]
}
