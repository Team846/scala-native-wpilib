...
/**
  ...
  */
@SuppressWarnings(Array("JavadocMethod")) object HLUsageReporting {
  private var impl: Interface = null

  @SuppressWarnings(Array("MethodName")) def SetImplementation(implementation: HLUsageReporting.Interface): Unit = {
    impl = implementation
  }
  ...
  class Null extends HLUsageReporting.Interface {
    ...
    @SuppressWarnings(Array("PMD.UnusedFormalParameter")) override def reportPIDController(num: Int): Unit = {
    }
