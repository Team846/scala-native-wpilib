...
/**
  ...
  */
@FunctionalInterface trait TableEntryListener {
  /**
    ...
    */
  def valueChanged(table: NetworkTable, key: String, entry: NetworkTableEntry, value: NetworkTableValue, flags: Int): Unit
}
